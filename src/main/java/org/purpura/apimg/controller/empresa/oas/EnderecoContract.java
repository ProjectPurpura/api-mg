...
public interface EnderecoContract {
    ...
    List<EnderecoResponseDTO> getEnderecos(@Parameter(description = "CNPJ da empresa", example = "12345678000195") @PathVariable String cnpj);
    ...
    @ResponseStatus(HttpStatus.OK)
    EnderecoResponseDTO getEndereco(@Parameter(description = "CNPJ da empresa", example = "12345678000195") @PathVariable String cnpj,
    ...
    EnderecoResponseDTO addEndereco(@Parameter(description = "CNPJ da empresa", example = "12345678000195") @PathVariable String cnpj,
    ...
    @ResponseStatus(HttpStatus.OK)
    void updateEndereco(@Parameter(description = "CNPJ da empresa", example = "12345678000195") @PathVariable String cnpj,
                        @Parameter(description = "ID do endereço", example = "1") @PathVariable String id,
                        @RequestBody @Valid EnderecoRequestDTO endereco);
    ...
    @ResponseStatus(HttpStatus.OK)
    void deleteEndereco(@Parameter(description = "CNPJ da empresa", example = "12345678000195") @PathVariable String cnpj,
                        @Parameter(description = "ID do endereço", example = "1") @PathVariable String id);
}
